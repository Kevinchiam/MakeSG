    ...
    <section className="container-shell py-12">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <h1 className="mt-2 font-serif text-5xl font-semibold">Post a job for MakeSG businesses to review</h1>
          <p className="mt-5 text-lg leading-8 text-[#6d675d]">
            Create a focused job listing with scope, budget, timing, services needed and contact details. Businesses can browse open jobs and reach out directly.
          </p>
